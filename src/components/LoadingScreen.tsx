...
export default function LoadingScreen({ onFinish }: LoadingScreenProps) {
  ...
  return (
    // Z-index tinggi (z-[999]) dan transisi opacity untuk efek fade
    <div
    ...
    >
      <div className="flex flex-col items-center justify-center">
        {/* LOGO Spinner (Ganti dengan komponen Image logo Anda jika sudah siap) */}
        ...
        <div className="mt-4 w-40 h-1 bg-gray-700 rounded-full overflow-hidden">
          {/* Animasi loading murni CSS (infinite progress) */}
