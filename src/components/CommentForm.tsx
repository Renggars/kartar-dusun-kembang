...
// Variasi untuk item-item di dalam form (Staggering)
  ...
  return (
    ...
    >
      ...
      <motion.form
        ...
        variants={{ visible: { transition: { staggerChildren: 0.1 } } }} // Stagger untuk input
        initial="hidden"
        animate="visible" // Gunakan animate karena form sudah terlihat di whileInView container
      >
        {/* Nama Lengkap */}
        <motion.label
