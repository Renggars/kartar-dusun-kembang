            ...
            <div className="flex h-full w-full max-w-4xl gap-12">
              ...
              <div className="flex flex-col w-1/2 gap-12">
                ...
                <div className="relative h-1/2 bg-gray-800 rounded-sm overflow-hidden mt-28">
                  ...
                  />
                  <div
                    className={`absolute bottom-3 left-3 bg-[#1581bc] text-white text-xs font-bold px-2 py-1 rounded-sm transition-opacity duration-300 ${
              ...
              <div className="flex flex-col w-1/2 gap-12">
                ...
                <div className="relative h-1/2 bg-gray-600 rounded-sm overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute top-3 right-3 text-[#1581bc] font-bold text-xl transition-opacity duration-300 ${
              ...
              {navLinks.map((link, index) => (
                <Link
                  ...
                  className={`
                    ...
                    ${
                      // Hanya Link yg sedang di-hover yg berwarna biru
                      hoveredIndex === index
