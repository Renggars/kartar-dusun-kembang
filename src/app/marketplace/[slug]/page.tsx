...
// --- TAMBAHKAN IMPORT NAVBAR ---
import MarketplaceNavbar from "@/components/MarketplaceNavbar"; // Sesuaikan path ini jika komponen Anda di lokasi lain
// -----------------------------
...
export default function MarketplaceDetailPage() {
  ...
  return (
    <>
      {" "}
      {/* MENGGUNAKAN FRAGMENT UNTUK MEMBUNGKUS NAVBAR & KONTEN */}
      <MarketplaceNavbar />
