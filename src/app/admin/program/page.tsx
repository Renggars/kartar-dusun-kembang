    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto text-gray-900">
      ...
      <div className="grid gap-4">
        {programsQuery.data?.map((p: ProgramItem) => (
          <div
            key={p.id}
            // Menerapkan flex-col pada mobile dan flex-row pada md
          ...
          >
            {/* KONTEN KIRI: Gambar, Judul, Tanggal */}
            <div className="flex items-start gap-4 grow">
              ...
              <div className="flex flex-col justify-center">
                ...
                {/* Tampilkan kategori di bawah tanggal untuk informasi lebih lanjut */}
            ...
            {/* KONTROL KANAN: Tombol Edit/Hapus */}
